...
\usepackage[utf8]{inputenc} % atau 
\usepackage{float}
\usepackage{array}
\usepackage{pdflscape}
% --- tambahan preamble ---
\usepackage{tabularx}       % agar tabel bisa mengisi lebar \textwidth
\usepackage{pifont}         % untuk tanda centang (\ding{51}) dan silang (\ding{55})
...
\begin{center}
    ...
    {\Large\bfseries Analisis Sistem Pengadaan Digital untuk Meningkatkan Efektivitas di PT Kilang Pertamina Internasional}\\
     \vspace{4cm}
    ...
    {\large Oleh}\\[0.3cm]
    \textbf{
    {\large Bihurin Salsabila Firdaus}\\
    {\large 18222015}
    }\\
...
% ==========================================
	Pembimbing  \\[3cm]
	Dr. Lenny Putri Yulianti, S.T., M.T.   \\[0.2cm]
	NIP. 119110073 
% ==========================================
...
\input{Bab III - Analisis-Masalah.tex}
